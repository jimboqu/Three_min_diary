...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { daily: @day.daily, effort: @day.effort, gift: @day.gift, improvement: @day.improvement, thing: @day.thing } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { daily: @day.daily, effort: @day.effort, gift: @day.gift, improvement: @day.improvement, thing: @day.thing } }
